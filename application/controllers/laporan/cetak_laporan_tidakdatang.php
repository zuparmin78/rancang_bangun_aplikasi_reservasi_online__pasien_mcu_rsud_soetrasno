...
class cetak_laporan_tidakdatang extends CI_Controller
{
    ...
    function index()
    {
        ...
        $pdf->Cell(0, 7, 'LAPORAN PASIEN MCU TIDAK DATANG', 0, 1, 'C');
        $pdf->Cell(10, 7, '', 0, 1);
        ...
        $header = array('No', 'Tanggal Kedatangan', 'NIK', 'Nama Pasien', 'Tempat, Tanggal Lahir', 'Alamat', 'Nama Paket');
        // Data loading
        $data = $bagus;
        // $data = $pdf->LoadData('countries.txt');
        $pdf->SetFont('Arial', '', 8);
        $pdf->ImprovedTableConfirm($header, $data);
