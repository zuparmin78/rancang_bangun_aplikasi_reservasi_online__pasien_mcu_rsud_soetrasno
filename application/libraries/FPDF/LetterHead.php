<?php
require_once APPPATH . '/libraries/FPDF/LetterSignature.php';

class LetterHead extends LetterSignature
{
    var $widths;
    var $font_style;
    var $font_size;
     ...
     */
    function AddLetterHead(array $data, $file, $keterangan = null, $width_keterangan = 25)
    {
