<?php
require_once APPPATH . '/libraries/FPDF/WrapTable.php';
...
//        }
     ...
     */
    function Signature($tanggal, $nama_kepala, $kabupaten, $jenis_kepala, $jenis = 1, $height_of_cell = 60, $orientation = 'L')
    {
        ...
        switch ($jenis) {
            ...
            default: // portrait final
                ...
                if ($height_of_cell > $space_bottom) {
                    $this->AddPage();
                    $this->Ttd($tanggal, $nama_kepala, $kabupaten, $jenis_kepala, $orientation);
    ...
    function Ttd($tanggal, $nama_kepala, $kabupaten, $jenis_kepala, $orientation)
    {
        switch (strtoupper($orientation)) {
            case 'L':
                ...
                $this->Cell(180);
                $this->Cell(85, 4, $kabupaten . ", " . $tanggal, 0, 0, 'C');
                $this->Ln();
                $this->SetFont('Arial', 'B', $this->default_font_size);
                $this->Cell(180);
                $this->MultiCell(85, 6, $jenis_kepala . ",\n\n\n\n" . $nama_kepala, 0, 'C');
                break;
