    ...
    <div class="d-sm-flex align-items-center justify-content-center">
        <div class="card shadow mb-4">
            <div class="card-header bg-success text-white">
                <h5 scrolldelay="100">Cetak Laporan Pasien MCU Terkonfirmasi</h5>
            </div>
            <div class="card-body">
                <form action="laporan/cetak_laporan_terkonfirmasi" method="post">
...
<script>
    function submitForm() {
        ...
        if (!max_tanggal || !min_tanggal) {
            ...
            xhr.open("POST", "<?php echo base_url('laporan/cetak_laporan_terkonfirmasi'); ?>", true);
